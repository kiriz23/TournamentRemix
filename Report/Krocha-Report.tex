...
\cmidrule(lr){2-3} \cmidrule(lr){4-5} \cmidrule(lr){6-7}
 ...
 & \multicolumn{1}{c}{\textit{$R^2_{adj}=0.671$}} & & \multicolumn{1}{c}{\textit{$R^2_{adj}=0.361$}} & & \multicolumn{1}{c}{\textit{$R^2_{adj}=0.703$}} & \\
\midrule
constant & 1.2585 & 0.000 		& 0.8643 & 0.000 		& 0.1445 &0.162 \\
Initial C rate & -0.1003& 0.004		&-0.0549 & 0.251 		& -0.0451 & 0.167 \\
CC rate & -1.2553 & 0.000 		& -0.1011 & 0.634		& 1.1931 & 0.000 \\
DD rate & -0.4578 & 0.007		& -0.9944 & 0.000		& -0.0969 & 0.547 \\
CC\_to\_C\_rate & 0.1127 & 0.130 	& -0.0643 & 0.535		& -0.2873 & 0.000 \\
DD\_to\_C\_rate & 0.0308 & 0.563 	& 0.1306 & 0.079		& 0.1064 & 0.036 \\
\bottomrule
\end{tabular}
...
The regression model we got is not surprising and largely confirms the conclusions from above – for instance it confirms the negative effect of high CC rate on strategy performance in win-based tournaments, as well as positive effect of high DD rate on rankings in Schulze tournament. This implies once again that new formats tend to favour aggressive behavior. The relatively high adjusted $R^2$
