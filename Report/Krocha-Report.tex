...
The values of payoffs in this work are set to $R=3$, $P=1$, $T=5$, and $S=0$, which correspond to the parameters employed in the original Axelrod tournaments \cite{doi:10.1177/002200278002400101} and have been widely adopted in subsequent research.
...
\begin{itemize}
    ...
    \item \textbf{Schulze method:} originally developed for preferential voting systems, extends this idea further by constructing a pairwise comparison graph of all strategies and determining rankings based on the strongest paths of victories. This allows for a more nuanced assessment of relative dominance and transitive preferences within the population of strategies.
\end{itemize}
...
The main tool for running tournaments and collecting data is \textbf{Axelrod-Python}~\cite{vince_knight_2017_807699}  -  an open-source research framework designed specifically for the study of the Iterated Prisoner’s Dilemma.  
...
The code for implementing Schulze method uses summary provided by Axelrod-Python library to calculate pairwise winning matrix, which contains differences in scores between each pair of strategies. The algorithm for evaluating the best strategies is presented below:
...
To analyze the effectiveness of different tournament evaluation methods, we first conducted the recreation of first Axelrod’s tournament, which served as a baseline for subsequent comparisons. This classic format is based on the average score obtained by each strategy over multiple pairwise interactions. Each strategy plays against every other strategy, including itself, over a fixed number of rounds, and the final ranking is determined by the mean payoff per match. 
...
Axelrod’s first tournament included 14 strategies (plus a random “strategy”) and they are listed below\cite{doi:10.1177/002200278002400101}:
...
\end{tabular}
\caption{Strategies from Axelrod’s first tournament}
\end{table}
...
0    & First by Stein   and Rapoport & 2.583571      & 0.602929            & 10               \\
1    & First by Grofman          & 2.5275        & 0.848357            & 1                  \\
2    & First by Shubik               & 2.508214      & 0.613429            & 3                  \\
3    & Tit For Tat                                 & 2.4925        & 0.717357            & 0                   \\
4    & First by Nydegger        & 2.461071      & 0.996               & 0                    \\
5    & First by Tideman   and Chieruzzi    & 2.458929      & 0.597286            & 11                 \\
6    & Grudger      & 2.401071      & 0.537929            & 5               \\
7    & First by Davis    & 2.399643      & 0.547571            & 4                  \\
8    & First by   Graaskamp     & 2.262857      & 0.565571            & 4                    \\
9    & First by Downing             & 2.2375        & 0.362571            & 7                   \\
10   & First by Feld  & 1.902143      & 0.290357            & 10                  \\
11   & First by Tullock       & 1.833571      & 0.311357            & 8                  \\
12   & First by Joss & 1.774286      & 0.2895              & 11                  \\
13   & First by   Anonymous      & 1.641071      & 0.505               & 3            \\
14   & Random: 0.5       & 1.620714      & 0.502714            & 3         \\  \hline
\end{tabular}
\caption{Summary of the first tournament}
\end{table}

It can be observed from the table above that the best-performing strategies in the classic tournament are not necessarily those that achieve the highest number of wins. For example, \textit{First by Joss} records 11 wins but is ranked only 12th overall. This observation is further supported by the Spearman’s rank correlation between the strategy’s position in the classic ranking and its number of wins, which in this setup equals approximately 0.2428. Such a low correlation indicates that the alternative evaluation formats proposed in this work are likely to produce substantially different rankings compared to the original tournament.
...
\begin{tabular}{llll}
\hline
Rank & Schulze\_Rank & Win\_Based\_Rank & Name                                      \\ \hline
0    & 3             & 2                & First by Stein and Rapoport: 0.05: (D, D) \\
1    & 12            & 12               & First by Grofman                          \\
2    & 7             & 10               & First by Shubik                           \\
3    & 13            & 13               & Tit For Tat                               \\
4    & 14            & 14               & First by Nydegger                         \\
5    & 2             & 1                & First by Tideman and Chieruzzi: (D, D)    \\
6    & 4             & 6                & Grudger                                   \\
7    & 5             & 7                & First by Davis: 10                        \\
8    & 8             & 8                & First by Graaskamp: 0.05                  \\
9    & 9             & 5                & First by Downing                          \\
10   & 1             & 3                & First by Feld: 1.0, 0.5, 200              \\
11   & 6             & 4                & First by Tullock                          \\
12   & 0             & 0                & First by Joss: 0.9                        \\
13   & 10            & 11               & First by Anonymous                        \\
14   & 11            & 9                & Random: 0.5                              \\ \hline
\end{tabular}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Images/compar_of_ranks.png}
\caption{Difference in rankings}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Images/schulze_win_line.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Images/rank_diff.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Images/top10schulze.png}
...
Overall, the main findings from the smaller tournament were confirmed, providing a clearer understanding of how the new formats change the tournament environment. The most significant results observed for the Schulze ranking are summarized below:
\begin{enumerate}
...
To validate these insights, the study extended the experiment to a much larger tournament involving 224 strategies. The expanded scope introduced greater behavioral diversity, allowing for a more statistically robust examination of patterns. Correlation analysis across ranking methods again confirmed the earlier observations: the Classic ranking maintained a weak or even negative correlation with the new methods, while the Schulze and win-based rankings showed only moderate agreement. This divergence emphasized that the alternative evaluation systems capture distinct dimensions of performance - efficiency in the Classic sense versus dominance and resilience in direct interactions.
